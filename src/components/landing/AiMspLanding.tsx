...
const ASSETS = {
  ...
  heroGrid: '/assets/hero-bg.png',
  heroGridOverlay: 'https://placehold.co/481x629',
  speaker1: '/assets/speaker1.png',
  speaker2: '/assets/speaker2.png',
  logo1: '/assets/logo1.png',
  logo2: '/assets/logo2.png',
  logo3: '/assets/logo3.png',
  logo4: '/assets/logo1.png',
  videoPoster: '/assets/video-poster.png',
  reel1: '/assets/reel1.png',
  reel2: '/assets/reel2.png',
  reel3: '/assets/reel3.png',
  reel4: '/assets/reel4.png',
};
...
const speakers = [
  {
    ...
    bio: 'You are not booking just another tech speaker. You are bringing in a leader who runs an MSP every single day and understands the real pressure of modern IT.',
    highlights: [
  ...
  },
  {
    ...
    bio: '15+ years working at the intersection of Human–Computer Interaction, applied AI systems, and emerging technologies.',
    highlights: [
...
const videoReels = [ASSETS.reel1, ASSETS.reel2, ASSETS.reel3, ASSETS.reel4];

const trustLogos = [ASSETS.logo1, ASSETS.logo2, ASSETS.logo3, ASSETS.logo4];

export function AiMspLanding() {
  return (
    <div className="bg-slate-950 text-white">
      <Hero navItems={navItems} assets={ASSETS} trustLogos={trustLogos} />
