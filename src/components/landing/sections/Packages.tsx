        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          {packages.map((pkg) => (
            ...
            >
              ...
              <p className="mt-4 text-xs text-white/70">Best for: {pkg.bestFor}</p>
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-3 text-sm text-white/70">
                We can create a tailored speaking engagement that perfectly fits your event format,
                audience size, and objectives.
              </p>
            </div>
            <Button className="w-full lg:w-auto">Inquire about this package</Button>
          </div>
        </div>
      </div>
    </section>
